...
<div class="card">
    <div class="card-body">
        ...
        <div class="col-12">
            <form action="{{ route('searchCategory') }}" method="get">
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Search" aria-describedby="button-addon2" name="keyword">
        ...
        <div class="container d-flex justify-content-end">
            <!-- Create Modal -->
            <button type="button" class="btn btn-primary my-auto" data-bs-toggle="modal" data-bs-target="#createCategoryModal">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Edit Modal -->
                                <button type="button" class="btn btn-warning m-2" data-bs-toggle="modal" data-bs-target="#editCategoryModal{{ $row->id }}">
