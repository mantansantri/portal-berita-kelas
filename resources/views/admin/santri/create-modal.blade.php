        ...
        <div class="modal-content">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="inputImage" class="form-label">Birth</label>
                            <input class="form-control" type="date" id="inputImage" name="phone"
                            value="{{ old('phone') }}">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">Add Santri</button>
                </div>
            </form>
        </div>
    </div>
